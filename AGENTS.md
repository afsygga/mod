...
`ISteamUser/GetPlayerSummaries` раз в 60с, ОДНИМ запросом на все привязанные
каналы (Steam принимает до 100 steamid), поэтому суточный лимит не при делах.
Push-уведомлений у Steam нет, только опрос.
