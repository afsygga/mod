...
Настройка — вкладка **Steam** в админке: глобальный выключатель, привязки
`канал → SteamID64` (строго 17 цифр, vanity-URL не годится), поведение при
выходе из игры, ручные соответствия имён (`steam_category_map`) на случай, когда
fuzzy-поиск Twitch промахивается, и кнопка разовой синхронизации.
