...
Push-уведомлений у Steam нет — только опрос: каждые 10с, пока хоть один
привязанный канал в эфире, иначе раз в 60с. Реагируем на СМЕНУ игры,
...
## Опрос (SteamSync.syncOnce, 10с при живом канале / 60с иначе; джоба `steam_sync`)
